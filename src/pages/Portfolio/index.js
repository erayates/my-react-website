    ...
    <div className='container mx-auto'>
      ...
      {status === 'succeeded' &&
        <div className='flex bg-white p-10 rounded-lg'> 
          <div className='left__profile w-1/3 flex flex-col items-center'>
          ...
          <div className='w-3/4'>
            <h2 className='text-4xl font-bold mb-5 text-slate-700 text-center'>Github Repositories</h2>
            <div className='flex flex-wrap justify-center'>
              {repos.map((repo,idx) => {
                return (
                    <div className='w-[300px] p-2' key={idx}>
