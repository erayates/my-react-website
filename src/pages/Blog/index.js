...
function Index() {
  return (
    <div className='w-3/4 mx-auto mt-5 bg-white rounded-lg' >
        <div className='w-3/4 mx-auto mb-10 pt-8'>
        ...
        <div className='flex flex-col absolute right-[100px] items-center w-1/3'>
            <ul className='flex flex-col items-center w-[250px] mt-8'>
                <li className='text-lg font-bold px-2 py-1 mb-3 w-full rounded bg-yellow-200 text-yellow-800 cursor-pointer hover:scale-105 border'>HTML5</li>
                <li className='text-lg font-bold px-2 py-1 mb-3 w-full rounded bg-yellow-200 text-yellow-800 cursor-pointer hover:scale-105 border'>CSS3</li>
                <li className='text-lg font-bold px-2 py-1 mb-3 w-full rounded bg-yellow-200 text-yellow-800 cursor-pointer hover:scale-105 border'>Javascript</li>
                <li className='text-lg font-bold px-2 py-1 mb-3 w-full rounded bg-yellow-200 text-yellow-800 cursor-pointer hover:scale-105 border'>React</li>
            </ul>
        </div>
